 ...
 * Examples:
 * ```
 * var result = await api.createDepartment(name, opts);
 * ```
 * Opts:
 ...
 * var result = await api.updateDepartment(id, opts);
 * ```
 *
 * Opts:
 * - `name`, 新的部门名字。可选
 ...
 * Examples:
 * ```
 * var result = await api.deleteDepartment(id);
 * var result = await api.deleteDepartment([id1, id2]);
 * ```
 *
 * Result:
 * ```
 ...
 * Examples:
 * ```
 * var result = await api.getDepartments();
 * ```
 *
 * Result:
 * ```
