...
exports.get_suite_token = async function (suite_ticket) {
	var suite_ticket = await this.ensureSuiteTicket();
...
exports.get_pre_auth_code = async function () {
  var suite_access_token = await this.ensureSuiteAccessToken();
...
exports.set_session_info = async function (pre_auth_code, appid) {
  var suite_access_token = await this.ensureSuiteAccessToken();
...
exports.get_permanent_code = async function (auth_code) {
  var suite_access_token = await this.ensureSuiteAccessToken();
...
exports.get_auth_info = async function (auth_corpid, permanent_code) {
  var suite_access_token = await this.ensureSuiteAccessToken();
...
exports.get_corp_token = async function (auth_corpid, permanent_code) {
  var suite_access_token = await this.ensureSuiteAccessToken();
